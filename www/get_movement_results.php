...
if (!file_exists($filename)) {
    ...
    MINUTE(from_unixtime(time_stamp/900)) as minute, location.building, ssid.id as s1, ssid.ssid as s2 FROM probes, location, ssid where MAC_hash = "f4:0f:24:0a:7c:45" and
    ssid_id = "11096" and location.id = probes.loc_id and ssid.id = probes.ssid_id group by month, day, hour, minute,loc_id, s1,s2;");
